...
def get_optimizer(model, args, learning_rate, remove_pooler=False):
    ...
    params_name, params = get_training_params_neptune(model, run,  print_stats=True)
...
#     with open("Parameter/01_27/vanilla_1.txt", 'a') as f:
