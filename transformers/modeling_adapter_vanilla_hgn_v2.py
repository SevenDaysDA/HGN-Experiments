...
ROBERTA_PRETRAINED_MODEL_ARCHIVE_MAP = {
    ...
    "albert": "https://s3.amazonaws.com/models.huggingface.co/bert/albert-base-v2-pytorch_model.bin",
}
...
class RobertaModelAdapter(BertModel):
    ...
    ######################################################    CHANGE        ##################################################
    #config_class = AdaperAlbertConfig
...
class VanillaAdapter_HGN_v2(nn.Module):
    ...
    def forward(
            ...
            batch['context_mask'] = batch['context_mask'].float().to('cuda')
            return self.hgn(batch, return_yp=return_yp)
