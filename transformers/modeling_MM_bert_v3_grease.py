...
class BertLayer(nn.Module):
    ...
    def forward(
        ...
        # Grease approach (6 layer without graphical information + 6 layer with grpahical information)
        # logger.info("Layer No.: ",self.layer_no)
        
        # ipdb.set_trace()
        # outputs_text = outputs_text + outputs_graph
