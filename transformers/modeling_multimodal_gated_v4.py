...
from .modeling_multimodal_struct_gated_v4 import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu
...
class MultiModalStructAdaptRobertaGated_v4(nn.Module):
    def __init__(self, config):
        super(MultiModalStructAdaptRobertaGated_v4, self).__init__()     
    ...
    def forward(
            ...
            multimodal_input_state = input_state[0] + input_state_graph[0]
            ...
            predictions = self.predict_layer(batch, multimodal_input_state, packing_mask=query_mapping, return_yp=return_yp)
